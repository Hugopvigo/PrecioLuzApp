package es.hugopvigo.precioluz.data.repository

import es.hugopvigo.precioluz.data.api.EsiosApi
import es.hugopvigo.precioluz.domain.model.DayPrices
import es.hugopvigo.precioluz.domain.model.HourPrice
import es.hugopvigo.precioluz.domain.model.PriceTier
import es.hugopvigo.precioluz.domain.model.Tramo
